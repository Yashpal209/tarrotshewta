...
<head>
    ...
    <link rel="shortcut icon" href="images/tarrot.png" type="image/x-icon">
    <!-- Swiper CSS -->
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="logo">
                            <a href="index.php">
                                <img src="images/tarrot.png" alt="Tarrot with Shweta Logo">
                            </a>
                            <div class="logo-text">
                    ...
                    <div class="col-lg-6 col-md-6 text-end">
                        <div class="contact-info">
                            ...
                            <div class="social-links hide">
                                ...
                                <a href="https://www.youtube.com/@tarrotwithshweta" ><i class="fab fa-youtube fa-xl text-danger"></i></a>
                            </div>
