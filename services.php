    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="mb-4">Book a session now and start your journey to spiritual enlightenment.</p>
                <div class="cta-buttons">
                    <a href="booking.php" class="btn btn-lg btn-primary me-3">Book Now</a>
                    <a href="contact.php" class="btn btn-lg btn-outline-primary">Contact Us</a>
                </div>
            </div>
        </div>
    </div>
